...
export default function Home(props) {
    ...
    const entryTransition = 1.5;
    const staggerTransition = 0.5;
    ...
    return (
        <main className="overflow-hidden duration-20 transition-all">
            ...
            <section className='p-[2rem] mx-auto max-w-screen-2xl'>
                <NavBar handleAboutPressed={props.handleAboutPressed} />

                <div className='flex flex-col sm:flex-row justify-center align-middle  '>
                    <motion.div className='max-w-md pb-[140px] flex flex-col pt-[2rem] sm:gap-8 sm:pb-0 z-[1] drop-shadow-md' initial={{
                        y: 100,
                        opacity: 0
                    }} animate={{
                        y: 0,
                        ...
                        <motion.ul className='flex flex-col gap-4 pl-1 text-primary ' variants={props.containerVariants} initial="hidden" animate="visible">
                            <motion.li variants={props.itemVariants} className='flex flex-row items-center gap-2'>
                        ...
                        <motion.div className='flex flex-col gap-4 ml-5 ' initial={{
                            opacity: 0
                        }} animate={{
                            opacity: 1
                        }} transition={{
            ...
            <section className='bg-base-200 p-5 h-fit' ref={props.aboutSectionRef}>
